...
//     std::cout << "Opening bangalore/stations.txt...\n";
//     std::ifstream stations_file("bangalore/stations.txt");
//     if (!stations_file.is_open()) {
//         std::cerr << "Failed to open bangalore/stations.txt\n";
//         return;
//     }
...
//             continue;
//         }
//         // Read station name word by word until '#' or end of line
//         std::string token;
...
//     }
//     stations_file.close();
//     std::cout << "Finished reading bangalore/stations.txt. Max ID: " << max_id << "\n";
...
//     std::cout << "Opening bangalore/connections.txt...\n";
//     std::ifstream connections_file("bangalore/connections.txt");
//     if (!connections_file.is_open()) {
//         std::cerr << "Failed to open bangalore/connections.txt\n";
//         return;
//     }
...
//     std::cout << "Finished reading bangalore/connections.txt\n";
// }
